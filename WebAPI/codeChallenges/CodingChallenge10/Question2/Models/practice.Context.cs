...
namespace Question2.Models
{
    ...
    public partial class practiceEntities2 : DbContext
    {
        ...
        [DbFunction("practiceEntities2", "fn_FindCustomerByCountryName")]
        public virtual IQueryable<fn_FindCustomerByCountryName_Result> fn_FindCustomerByCountryName(string country)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_FindCustomerByCountryName_Result>("[practiceEntities2].[fn_FindCustomerByCountryName](@country)", countryParameter);
        }
    
        [DbFunction("practiceEntities2", "fn_GetEmpByJob")]
        public virtual IQueryable<fn_GetEmpByJob_Result> fn_GetEmpByJob()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_GetEmpByJob_Result>("[practiceEntities2].[fn_GetEmpByJob]()");
        }
